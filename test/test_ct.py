...
class TestNRRDCT(unittest.TestCase):
    def setUp(self):
        ...
        self.brain1_masked_ct = SimpleImage('brain1', 'CT1', self.brain1_image_path,
                                            mask_path=self.brain1_label_path)
        self.brain1_unmasked_ct = SimpleImage('brain1', 'CT1',
    ...
    def test_load(self):
        ...
        self.assertEqual(SimpleImage.get_array(brain1_image).shape,
                         self.brain1_dims)
        self.assertEqual(SimpleImage.get_array(brain1_label).shape,
                         self.brain1_dims)
    ...
    def test_load_preserves_content(self):
        brain1_image, brain1_label = self.brain1_masked_ct.load()
        brain1_image_array = SimpleImage.get_array(brain1_image)
        brain1_label_array = SimpleImage.get_array(brain1_label)
